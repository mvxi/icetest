...
public:
    ...
    ::Ice::Int multiply(::Ice::Int num1, ::Ice::Int num2)
    {
        return multiply(num1, num2, 0);
    }
    ::Ice::Int multiply(::Ice::Int num1, ::Ice::Int num2, const ::Ice::Context& __ctx)
    {
        return multiply(num1, num2, &__ctx);
    }
    
private:

    ::Ice::Int multiply(::Ice::Int, ::Ice::Int, const ::Ice::Context*);
...
public:
    ...
    ::std::string retString(const ::Ice::Context& __ctx)
    {
        return retString(&__ctx);
    }
    
private:

    ::std::string retString(const ::Ice::Context*);
...
public:
    ...
    virtual ::Ice::Int add(::Ice::Int, ::Ice::Int, const ::Ice::Context*) = 0;

    virtual ::Ice::Int multiply(::Ice::Int, ::Ice::Int, const ::Ice::Context*) = 0;

    virtual ::std::string retString(const ::Ice::Context*) = 0;
};
...
public:
    ...
    virtual ::Ice::Int add(::Ice::Int, ::Ice::Int, const ::Ice::Context*);

    virtual ::Ice::Int multiply(::Ice::Int, ::Ice::Int, const ::Ice::Context*);

    virtual ::std::string retString(const ::Ice::Context*);
};
...
public:
    ...
    virtual ::Ice::Int multiply(::Ice::Int, ::Ice::Int, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___multiply(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual ::std::string retString(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___retString(::IceInternal::Incoming&, const ::Ice::Current&);
